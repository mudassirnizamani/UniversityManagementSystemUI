...
@Component({
  selector: 'app-course-adviser',
  templateUrl: './course-adviser.component.html',
  styleUrls: ['./course-adviser.component.scss'],
})
export class CourseAdviserComponent implements OnInit {
  Form: FormGroup;
  isLoading: boolean;
  ...
  onSubmit() {
    if (this.Form.invalid) {
      ...
      this.authService.CourseAdviser(model).subscribe(
        (res: any) => {
          if (res.succeeded) {
            this.toastr.success(
